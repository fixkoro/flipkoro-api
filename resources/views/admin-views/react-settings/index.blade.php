                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" min="0" value="{{ $reactData ? $reactData['react_domain'] : '' }}" name="react_domain" class="form-control"  placeholder="{{translate('ex')}}: https://your-domain.com" required>
                            </div>
                        </div>
                    </div>
